...
public class ModModelProvider extends FabricModelProvider {
    ...
    public void generateItemModels(ItemModelGenerator itemModelGenerator) {
        ...
        itemModelGenerator.registerArmor(((ArmorItem) ModItems.NATION_2_IRON_BOOTS));
        itemModelGenerator.registerArmor(((ArmorItem) ModItems.NATION_2_IRON_CHESTPLATE));
        itemModelGenerator.registerArmor(((ArmorItem) ModItems.NATION_2_IRON_LEGGINGS));
        itemModelGenerator.registerArmor(((ArmorItem) ModItems.NATION_2_IRON_HELMET));
        ...
        itemModelGenerator.registerArmor(((ArmorItem) ModItems.NATION_9_NETHERITE_BOOTS));
        itemModelGenerator.registerArmor(((ArmorItem) ModItems.NATION_9_NETHERITE_CHESTPLATE));
        itemModelGenerator.registerArmor(((ArmorItem) ModItems.NATION_9_NETHERITE_LEGGINGS));
        itemModelGenerator.registerArmor(((ArmorItem) ModItems.NATION_9_NETHERITE_HELMET));
    }
}
