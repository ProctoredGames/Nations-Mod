...
//                .add(ModItems.NATION_2_NETHERITE_SWORD)
        ...
        getOrCreateTagBuilder(ItemTags.PICKAXES)
                ...
                .add(ModItems.NATION_3_NETHERITE_PICKAXE)
                .add(ModItems.NATION_8_NETHERITE_PICKAXE);
        getOrCreateTagBuilder(ItemTags.SHOVELS)
                .add(ModItems.NATION_9_NETHERITE_SHOVEL)
                .add(ModItems.NATION_3_NETHERITE_SHOVEL);
        getOrCreateTagBuilder(ItemTags.AXES)
                .add(ModItems.NATION_3_NETHERITE_AXE)
                .add(ModItems.NATION_9_NETHERITE_AXE)
                .add(ModItems.NATION_8_NETHERITE_AXE);
...
//                .add(ModItems.NATION_2_IRON_HELMET)
//                .add(ModItems.NATION_2_IRON_CHESTPLATE)
//                .add(ModItems.NATION_2_IRON_LEGGINGS)
//                .add(ModItems.NATION_2_IRON_BOOTS)
                ...
                .add(ModItems.NATION_9_NETHERITE_HELMET)
                .add(ModItems.NATION_9_NETHERITE_CHESTPLATE)
                .add(ModItems.NATION_9_NETHERITE_LEGGINGS)
                .add(ModItems.NATION_9_NETHERITE_BOOTS);
