...
public class ModItems {
    ...
    public static final Item NATION_1_ELYTRA = registerItem("nation_1_elytra", new ElytraItem(new Item.Settings().maxDamage(432).rarity(Rarity.UNCOMMON)));
    public static final Item NATION_2_ELYTRA = registerItem("nation_2_elytra", new ElytraItem(new Item.Settings().maxDamage(432).rarity(Rarity.UNCOMMON)));
    public static final Item NATION_3_ELYTRA = registerItem("nation_3_elytra", new ElytraItem(new Item.Settings().maxDamage(432).rarity(Rarity.UNCOMMON)));
    public static final Item NATION_4_ELYTRA = registerItem("nation_4_elytra", new ElytraItem(new Item.Settings().maxDamage(432).rarity(Rarity.UNCOMMON)));
    public static final Item NATION_5_ELYTRA = registerItem("nation_5_elytra", new ElytraItem(new Item.Settings().maxDamage(432).rarity(Rarity.UNCOMMON)));
    public static final Item NATION_6_ELYTRA = registerItem("nation_6_elytra", new ElytraItem(new Item.Settings().maxDamage(432).rarity(Rarity.UNCOMMON)));
    public static final Item NATION_7_ELYTRA = registerItem("nation_7_elytra", new ElytraItem(new Item.Settings().maxDamage(432).rarity(Rarity.UNCOMMON)));
    public static final Item NATION_8_ELYTRA = registerItem("nation_8_elytra", new ElytraItem(new Item.Settings().maxDamage(432).rarity(Rarity.UNCOMMON)));
