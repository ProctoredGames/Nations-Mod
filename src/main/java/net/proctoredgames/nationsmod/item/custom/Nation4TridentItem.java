...
//
//
//public class Nation4TridentItem extends TridentItem {
...
//
//    public Nation4TridentItem(Item.Settings settings) {
//        super(settings);
//    }
//
//    @Override
...
//                            if (f == 0.0F) {
//                                Nation4TridentEntity tridentEntity = new Nation4TridentEntity(world, playerEntity, stack);
...
//        Nation4TridentEntity tridentEntity = new Nation4TridentEntity(world, pos.getX(), pos.getY(), pos.getZ(), stack.copyWithCount(1));
